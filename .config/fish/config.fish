...
set -q GHCUP_INSTALL_BASE_PREFIX[1]; or set GHCUP_INSTALL_BASE_PREFIX $HOME ; test -f /home/john/.ghcup/env ; and set -gx PATH $HOME/.cabal/bin /home/john/.ghcup/bin /home/john/go/bin $PATH # ghcup-env
